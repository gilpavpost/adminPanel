      ...
      <div class="col-12 pl-0 pr-0">
        ...
        >
          <template v-slot:prev_img="{ row }">
            <b-img :src="baseUrl + row.prev_img.src + img_size"></b-img>
          </template>
  ...
  data() {
    return {
      ...
      tableOptions: {
        perPage: 10,
        headings: {
          id: this.$t("settingsSite.id"),
          title: this.$t("settingsSite.title"),
          group: this.$t("settingsSite.group"),
          type: this.$t("settingsSite.type"),
          actions: "",
        },
