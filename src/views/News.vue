      ...
      <div class="col-12 pl-0 pr-0">
        ...
        >
          <template v-slot:prev_img="{ row }">
            <b-img v-if="row.prev_img !== null" :src="imgUrl(row)"> </b-img>
          </template>
...
export default {
    ...
    return {
      ...
      tableOptions: {
        ...
        headings: {
          ...
          category_id: this.$t("news.category_id"),
          prev_img: this.$t("news.prev_img"),
          status: this.$t("news.status"),
          actions: "",
        },
  ...
  computed: {
    tableColumns() {
      ...
      return ["id", "title", "category_id", "prev_img", "status", ...actions];
    },
  },
  methods: {
    imgUrl(rowItem) {
